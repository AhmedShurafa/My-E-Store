...
{{--                                    @forelse($product->image_url as $image)--}}
                                        <div class="item"><img src="{{asset($product->image_url)}}" alt=""></div>
{{--                                    @empty--}}
{{--                                        <div class="item"><img src="{{asset($image)}}" alt=""></div>--}}
{{--                                    @endforelse--}}
                                </div>
                                <a class="popup-youtube ps-product__video"
                                   href="https://youtu.be/Hg5fUpBZng0">
                        ...
                        <div class="ps-product__thumbnail--mobile">
                            <div class="ps-product__main-img"><img src="{{asset($product->image_url)}}" alt=""></div>
                        ...
                        <div class="ps-product__info">
                            ...
                            <div class="ps-product__block ps-product__style">
                                ...
                                <ul>
                                    <li><a href="show.blade.php"><img src="images/shoe/sidebar/1.jpg" alt=""></a></li>
                                    <li><a href="show.blade.php"><img src="images/shoe/sidebar/2.jpg" alt=""></a></li>
                                    <li><a href="show.blade.php"><img src="images/shoe/sidebar/3.jpg" alt=""></a></li>
                                    <li><a href="show.blade.php"><img src="images/shoe/sidebar/2.jpg" alt=""></a></li>
                                </ul>
                            </div>
                            <form action="{{route('cart')}}" id="add_to_cart" method="post">
                                @csrf
                                ...
                                <div class="ps-product__shopping">
                                    <button type="submit" class="ps-btn mb-10">Add to
                                        cart<i class="ps-icon-next"></i>
                                    </button>
                        ...
                        <div class="tab-content mb-60">
                            <div class="tab-pane active" role="tabpanel" id="tab_01">
                                ...
                                <p>Sweet roll soufflé oat cake apple pie croissant. Pie gummi bears jujubes cake lemon
                                    drops gummi bears croissant macaroon pie. Fruitcake tootsie roll chocolate cake
                                    Carrot cake cake bear claw jujubes topping cake apple pie. Jujubes gummi bears
                                    soufflé candy canes topping gummi bears cake soufflé cake. Cotton candy soufflé
                                    sugar plum pastry sweet roll..</p>
                            </div>
